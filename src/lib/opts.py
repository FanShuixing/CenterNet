...
class opts(object):
    def __init__(self):
        ...
        # dataset
        self.parser.add_argument('--not_rand_crop',
                                 action='store_true',
        ...
        self.parser.add_argument('--no_color_aug',
                                 action='store_true',
                                 help='not use the color augmenation '
                                 'from CornerNet')
        # multi_pose
        self.parser.add_argument('--aug_rot',
                                 type=float,
                                 default=0,
                                 help='probability of applying '
                                 'rotation augmentation.')
        # ddd
        self.parser.add_argument('--aug_ddd',
                                 type=float,
                                 default=0.5,
                                 help='probability of applying crop augmentation.')
        self.parser.add_argument('--rect_mask',
                                 action='store_true',
                                 help='for ignored object, apply mask on the '
                                 'rectangular region or just center point.')
        self.parser.add_argument('--kitti_split',
                                 default='3dop',
        ...
        self.parser.add_argument('--hm_hp_weight',
                                 type=float,
                                 default=1,
        ...
        self.parser.add_argument('--scores_thresh',
                                 type=float,
                                 default=0.1,
        ...
        self.parser.add_argument('--eval_oracle_hmhp',
                                 action='store_true',
                                 help='use ground truth human joint heatmaps.')
        self.parser.add_argument('--eval_oracle_hp_offset',
                                 action='store_true',
    ...
    def parse(self, args=''):
        ...
        opt.data_dir = '/input0/'
        opt.exp_dir = os.path.join('/output', 'tf_dir', opt.task)
